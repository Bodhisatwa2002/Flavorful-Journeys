...
const Form = () => {
  ...
  const formSuccess = () => {
    toast("Thanks for connecting, I will contact with you shortly.");
    ...
    <div className="max-w-[1200px] mx-auto">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              name="from_name"
              type="text"
              className="h-[64px] bg-gray-200 outline-2 border-none text-black px-4"
              required
              autoComplete="off"
              onChange={onChange}
            />
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            name="message"
            className="h-[162px] bg-gray-200 outline-2 border-none text-black p-4 resize-none"
            required
            onChange={onChange}
          />
        </div>
        ...
        {/* SUBMIT BUTTON */}
        <button className="bg-[#000000] h-[64px] max-w-[585px] text-[16px] transition-transform active:scale-[0.95] text-white">
